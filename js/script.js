...
//////////////////////////////Create a gameScreen////////////////////////////////////////// 
//This step starts flying birds only once the start button is clicked
const gameScreen = () => {
    ...
    class crazyBird {
        ...
        draw(){
            /////Create a colorbox + sprite within it (so that collision just needs to be on box)
            // creating object box
            collisionCtx.fillStyle = this.color
            collisionCtx.fillRect(this.x, this.y, this.width, this.height)
            // creating sprite object inside a rectangle
    ...
    let explosions = []
    class Explosion {
        //Import x,y and size from outside (As it will depend upon the x,y and size of the birds)
